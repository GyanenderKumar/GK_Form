...
<body>
    ...
    <div class="container">
        <h1 class="text-center">GK_Form Categories</h1>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo ' <div class="col-md-4 mb-4">
                            <div class="card bg-dark text-light" style="width: 18rem;">
                                <img src="images/pic-' .$picnumber. '.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title"><a href="threadlist.php?categoryid=' .$category_id. '" class="text-success">' .$category_name. '</a></h5>
                                    <p class="card-text">'. substr($category_description,0,50) .' --></p>
                                    <a href="threadlist.php?categoryid=' .$category_id. '" class="btn btn-primary bg-success">View Threads..</a>
                                </div>
                            </div>
                        </div>';
